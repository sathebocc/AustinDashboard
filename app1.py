...
df = pd.read_csv(r"C:\Users\Sathy\Desktop\Austin ISD - Dashboard\bills_bkly.csv", parse_dates =["bill_start_date"], low_memory=False)
sqft_df = pd.read_csv(r"C:\Users\Sathy\Desktop\Austin ISD - Dashboard\sqft.csv")
df.columns.to_list()
df1 = df.iloc[:,:19]
